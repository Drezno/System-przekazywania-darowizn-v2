...
namespace Projek_MVC_v2.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "Hasło {0} musi posiadać minimalnie {2} oraz maksymalnie {1} znaków.", MinimumLength = 6)]
            [DataType(DataType.Password)]
            ...
            [Compare("NewPassword", ErrorMessage = "Te hasła nie pasują do siebie. Spróbuj ponownie.")]
