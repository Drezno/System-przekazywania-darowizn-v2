...
namespace Projek_MVC_v2.Areas.Identity.Pages.Account.Manage
{
    public class SetPasswordModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(100, ErrorMessage = "Hasło {0} musi mieć minimum {2} oraz maksimum {1} znaków.", MinimumLength = 6)]
            ...
            [Compare("NewPassword", ErrorMessage = "Wprowadzone hasła nie zgadzają się. Spróbuj ponownie.")]
